...
def crawl_all(urls: list[str], cfg: dict, schedule_mode: str = None) -> dict:
    ...
    return {
    "throughput_urls_per_s": throughput,
    "duration_s": duration,
    "scanned_pages": len(results),
    "broken_links": broken_links_total,
    "cascade_logins": cascade_logins_total,
    "affected_pages": pages_with_violations,
    "page_report_path": str(out_csv),
    "violations_report_path": str(viol_csv),
    "summary_report_path": str(summary_csv),
    "run_timestamp_utc": summary_row[0],
    }
